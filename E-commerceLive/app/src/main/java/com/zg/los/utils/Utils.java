...
public class Utils {
    ...
    public static String randomName(boolean isMan) {
        ...
        String first = firstList[randInt(0, firstList.length)];
        String second = isMan ? manList[randInt(0, manList.length)] : womanList[randInt(0, womanList.length)];
        return first + second;
    }
    ...
    public static String randProvince() {
        ...
        return provices[randInt(0, provices.length)];
    }
